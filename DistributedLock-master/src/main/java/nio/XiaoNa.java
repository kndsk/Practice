...
public class XiaoNa {
    ...
    private void init(){
        ...
        try {
            ...
            //绑定端口
            servSocketChannel.socket().bind(new InetSocketAddress(8080));
    ...
    private void handleKey(SelectionKey key)
        ...
        try{
            if(key.isAcceptable()){
                ...
                System.out.println("Server    accept :---" + channel.hashCode());
            }
                ...
                if(count > 0){
                    ...
                    */
                    ...
                    System.out.println("Server   write ---" + channel.hashCode());
                }
                else{
